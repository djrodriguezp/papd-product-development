...
def read_all_items():
    return [{"item_id": "un item"},{"item_id": "un item"},{"item_id": "un item"},{"item_id": "un item"},{"item_id": "un item"},
            {"item_id": "un item"},{"item_id": "un item"},{"item_id": "un item"},{"item_id": "un item"},{"item_id": "un item"}]
...
def get_role_permissions(rolename: RoleName):
    ...
    if rolename == "writer":
        return {"role": rolename, "permissions": "you are allowed to read and write."}

    return {"role": rolename, "permissions": "you have full access "}
...
def read_user_items(user_id: int, item_id: int, query: Optional[str], short: bool = False):
